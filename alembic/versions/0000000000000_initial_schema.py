...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('role', sa.Enum('FOUNDER', 'JUDGE', 'ADMIN', name='userrole'), nullable=False, server_default='FOUNDER'),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('DRAFT', 'UPCOMING', 'ACTIVE', 'CLOSED', 'JUDGING', 'COMPLETE', name='competitionstatus'), nullable=False, server_default='DRAFT'),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('DRAFT', 'PENDING_PAYMENT', 'SUBMITTED', 'UNDER_REVIEW', 'WINNER', 'NOT_SELECTED', 'REJECTED', name='submissionstatus'), nullable=False, server_default='DRAFT'),
    ...
    op.create_table(
        ...
        sa.Column('type', sa.Enum('ENTRY_FEE', 'PRIZE_PAYOUT', 'REFUND', name='paymenttype'), nullable=False),
